...
class User(Model):
    ...
    social_credits = IntegerField(default=100)
    status = CharField(default='Рабочий')

    status_list = ["Лидер партии", "Министр очень важных дел", "Министр не твоих собачи дел", "Рабочий"]
...
#                 return (True, tables) if set(tables) == self.config['expected_tables'] else (False, tables)
